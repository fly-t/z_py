...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionizhangtengfei_163_com.setObjectName(u"actionizhangtengfei_163_com")
        ...
        self.sendPanel.setFrameShape(QFrame.Shape.StyledPanel)
        ...
        self.sendLayout.addWidget(self.clearSendButton, 1, 9, 1, 1)

        self.sendButton = QPushButton(self.sendPanel)
        self.sendButton.setObjectName(u"sendButton")

        self.sendLayout.addWidget(self.sendButton, 0, 9, 1, 1)
        ...
        self.sendTextEdit.setMinimumSize(QSize(0, 100))

        self.sendLayout.addWidget(self.sendTextEdit, 0, 0, 2, 9)
        ...
        self.splitDisplayCheck = QCheckBox(self.sendPanel)
        self.splitDisplayCheck.setObjectName(u"splitDisplayCheck")

        self.sendLayout.addWidget(self.splitDisplayCheck, 2, 4, 1, 1)
        ...
        self.menuComm.addAction(self.actionssss)
        self.menuContact.addAction(self.actionizhangtengfei_163_com)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuComm.setTitle(QCoreApplication.translate("MainWindow", u"\u7248\u672c", None))
        self.menuContact.setTitle(QCoreApplication.translate("MainWindow", u"\u5173\u4e8e", None))
    # retranslateUi
